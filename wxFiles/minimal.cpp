...
{
private:
    MidWindow<MidWxWidgets>* parent = nullptr;
public:
    MidWXButton(MidWindow<MidWxWidgets>* parent = nullptr) :
    ...
    void setParent(MidWindow<MidWxWidgets>* parent)
    {
        this->parent = parent;
    }
};
...
class MidWxWidgets : public wxFrame
{
public:
    MidWxWidgets(int width, int height, const char * title);

    void addButton(MidWXButton *button) {}
...
public:
    ~MidWxMsgDialog() { delete msg; }
    MidWxMsgDialog()
    {
        msg = new wxMessageDialog(NULL, "", "", wxOK | wxICON_INFORMATION);
    }
    MidWxMsgDialog(const char* title, const char * text)
    {
        msg = new wxMessageDialog(NULL, text, title, wxOK | wxICON_INFORMATION);
    }
    void setText(const char *text)
    {
        wxMessageDialog* msgTemp = new wxMessageDialog(NULL, text, msg->GetTitle(),
    ...
    {
        wxMessageDialog* msgTemp = new wxMessageDialog(NULL, msg->GetMessage(),
...
bool MyApp::OnInit()
{
    ...
    MidWindow<MidWxWidgets> w(800, 600, "MidGui SIGA"); //Parent is null
    MidButton<MidWXButton, MidWxWidgets> b(&w, "Hello World Button"); //Parent is MidWindow
    w.addButton(10, 20, &b);
    w.show();

    MidMessageDialog<MidWxMsgDialog> d("Titulo", "Alo mundo");
    d.show();
    ...
    /*wxFrame *frame = new wxFrame(nullptr, wxID_ANY, _("Titulo"));
    frame->Show(true);*/
...
// frame constructor
//MidWxWidgets::MidWxWidgets(const wxString& title)
MidWxWidgets::MidWxWidgets(int width, int height, const char * title)
